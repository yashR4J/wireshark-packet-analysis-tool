...
#ifndef TEAMS_ANALYSIS_TEAMS_FLOW_TRACKER_H
#define TEAMS_ANALYSIS_TEAMS_FLOW_TRACKER_H
...
namespace teams {
    ...
    public:
        ...
        unsigned count_teams_flows_detected() const;
        unsigned long long count_total_pkts_processed() const;
        unsigned long long count_teams_pkts_detected() const;
        unsigned long long count_teams_bytes_detected() const;
    ...
    private:
        ...
        unsigned long long _teams_pkts_detected = 0;
        unsigned long long _teams_bytes_detected = 0;
    };
}
