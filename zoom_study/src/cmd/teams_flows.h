...
namespace teams_flows {
    ...
    cxxopts::Options set_options() {
        ...
        cxxopts::Options opts("teams_flows",
                              "Extracts packets associated with MS Teams and writes per-flow statistics");
        ...
        opts.add_options()
                ...
                ("z,zpkt-out", "teams packets binary output file (optional)",
