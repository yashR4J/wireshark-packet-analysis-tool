...
int main(int argc, char** argv) {
    ...
    auto config = teams_rtp::parse_options(teams_rtp::set_options(), argc, argv);

    teams::pkt pkt;
    simple_binary_reader<teams::pkt> pkt_reader(config.input_path);
    teams::offline_analyzer analyzer;
